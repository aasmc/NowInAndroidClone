...
import ru.aasmc.nowinandroid.core.database.NiaDatabase
...
class NewsResourceDaoTest {
    ...
    fun newsResourceDao_fetches_items_by_descending_publish_date() = runTest {
        ...
        episodeDao.insertOrIgnoreEpisodes(episodeEntityShells)
    ...
    fun newsResourceDao_filters_items_by_topic_ids_by_descending_publish_date() = runTest {
        ...
        val newsResourceTopicCrossRefEntities =
            topicEntities.mapIndexed { index, topicEntity ->
