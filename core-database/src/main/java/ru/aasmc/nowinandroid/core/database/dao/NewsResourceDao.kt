...
import ru.aasmc.nowinandroid.core.database.model.NewsResourceAuthorCrossRef
import ru.aasmc.nowinandroid.core.database.model.NewsResourceEntity
import ru.aasmc.nowinandroid.core.database.model.NewsResourceTopicCrossRef
import ru.aasmc.nowinandroid.core.database.model.PopulatedNewsResource
...
interface NewsResourceDao {
    @Query(
        value = """
            SELECT * FROM news_resources ORDER BY publish_date DESC
        """
    )
